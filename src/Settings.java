...
public class Settings extends JPanel implements ActionListener {
    ...
    Settings(GameContext t) {
        ...
        if (gameContext.isSoundOpen()) {
            toggleMusic.setIcon(new ImageIcon("btn/Open_On.png"));
        } else {
            toggleMusic.setIcon(new ImageIcon("btn/Open_Off.png"));
        }

        SettingPopup = new JLabel(
                new ImageIcon("pics/SettingBackGround.png"),
                JLabel.CENTER);
        SettingPopup.setBounds(
                0,
                0,
